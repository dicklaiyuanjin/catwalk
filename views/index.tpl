...
<html lang="zh-CN">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li class="text-center"><a href="/signinform">signin</a></li>
            <li class="text-center"><a href="/signupform">signup</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <div class="jumbotron text-center">
      ...
      <p>
        <a class="btn btn-primary btn-lg" href="/signinform">signin</a>
        <a class="btn btn-success btn-lg" href="/signupform">signup</a>
      </p>
    </div>
